...
module.exports = {
  ...
  //TODO: copy this function, call it _makeFixedVariant, and modify it to add the extesnsion
  //      DO NOT add any new variables! use options to pass in the configs from info.json
  //      @param {Object} options - should now be = {variant_seed, useFixedVariant, maxfixedVariant}
  /**
  ...
  //TODO: modify this function to choose between _makeVariant and _makeFixedVariant
  //      DO NOT add any new variables! use options to pass in the configs from info.json
  //      @param {Object} options - should now be = {variant_seed, useFixedVariant, maxfixedVariant}
  /**
  /**
